            ...
            <div class="card-body", align="center">
              <center>
                  ...
                  <?php
                    ...
                    $query = "select * from doc_details where username='$username'";
                    ...
                    if($run == true)
                    {
                        ...
                        ?>
                        <form class="form-group" method="post" action="update_doc_details.php" align="center">
                            <div class="row">
                              <div class="col-md-4"><label>Name </label></div>
                              <div class="col-md-8"><input type="text" name="Name" class="form-control" value=<?php echo $name ?> required/></div><br><br>
                              
                              <div class="col-md-4"><label>Specialization </label></div>
                              <div class="col-md-8"><input type="text" name="Specialization" class="form-control" value=<?php echo $spcl ?> required/></div><br><br>
                              
                              <div class="col-md-4"><label>Hospital </label></div>
                              <div class="col-md-8"><input type="text" name="Hospital" class="form-control" value=<?php echo $hname ?> required/></div><br><br>
                            ...
                            <center><input type="submit" id="updatebtn" name="update_doc" value="Update" class="btn btn-primary"></center>
                        </form>
